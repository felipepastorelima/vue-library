<template>
  <div class="app-page-toolbar">
    <router-link :to="{ path: '/book/new' }" v-if="hasPermissionToCreate">
      <el-button icon="el-icon-fa-plus" type="primary">
        <app-i18n code="common.new"></app-i18n>
      </el-button>
    </router-link>

    <router-link :to="{ path: '/book/import' }" v-if="hasPermissionToImport">
    ...
    <router-link
      :to="{ path: '/audit-logs', query: { entityNames: 'book' } }"
...
export default {
  name: 'app-book-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      hasRows: 'book/list/hasRows',
      loading: 'book/list/loading',
      exportLoading: 'book/list/exportLoading',
      selectedRows: 'book/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'book/list/doExport',
      doRemoveAllSelected:
        'book/list/doRemoveAllSelected',
      doDisableAllSelected:
        'book/list/doDisableAllSelected',
      doEnableAllSelected:
        'book/list/doEnableAllSelected',
      doDestroyAll: 'book/destroy/doDestroyAll',
    }),
